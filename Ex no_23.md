...
## Algorithm
Start. Define a variables. Write program to to store and display the name, id, age and salary of an employee using structure(using array of structure). Read the value using scanf. Ask the user to make an input. Print out the answer. End.
...
<img width="1055" height="274" alt="image" src="https://github.com/user-attachments/assets/feafce3b-3980-4223-92d0-1555397146a8" />
